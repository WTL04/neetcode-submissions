class Solution:
    def appendCharacters(self, s: str, t: str) -> int:
        ...
        m: two pointer problem where you use two pointers to compare of if the chars are equal
        ...
        p:
            ...
            run when reached end of s, record substring length to append
            while t pointer < length of t:
                add to res
                iterate t forward
        ...
        """
        eval: 
            time: O(s + t) where s and t are the length of s and t strings
            space: O(1), no storing in memory
        """
